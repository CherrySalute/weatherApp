$(document).ready(function(){
    //41544b0ae8d6ea4f6b29201a0e6e6add
    ...
    var myAPI = "41544b0ae8d6ea4f6b29201a0e6e6add";
    ...
    function w_info(){
        ...
        //append(), prepend() 자식을 추가하는 메서드는 기존 자식을 남기는 상태에서 새로운 자식들을 추가 ==> 기존 데이터를 새롭게 반복하여 적용하고자 할 때는 반복문 이전에 초기화가 필요
    ...
    $(document).on("click", ".cities button", function(){
        ...
        cityName.unshift(city_txt);  //cityName이라는 전역 변수에 배열 데이터의 첫번째 인덱스에 추출한 텍스트(도시명)를 넣어준다.
        console.log(cityName);
    ...
    navigator.geolocation.getCurrentPosition(function(position){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                cityName.unshift(city); //브라우저가 로딩하자마자 현재 나의 위치를 배열 데이터에 놓는다.
                w_info(); // 함수문을 호출한다. -> 배열 데이터의 개수에 따라 구조를 구정하고 그 데이터 내용을 넣겠다는 의미
            }
        });
